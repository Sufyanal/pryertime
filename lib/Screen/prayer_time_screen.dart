...
class _PrayerTimeScreenState extends State<PrayerTimeScreen> {
  ...
  Future<void> getPrayerTime({String city = "karachi"}) async {
    http.Response response = await http.get(Uri.parse("https://dailyprayer.abdulrcs.repl.co/api/${city}"));
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
            image: DecorationImage(fit: BoxFit.fitWidth, image: AssetImage("assets/bg.png"))),
